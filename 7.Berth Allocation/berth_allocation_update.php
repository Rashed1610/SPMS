...
$con = new MYSQLi("localhost","root","" ,"bb_spms" );
 ...
 $sql = "UPDATE `berth_allocation` SET `Visit_Id`='$_POST[Vi_Id]',`Berth_Id`='$_POST[B_Id]',`Alloc_S_Time`='$_POST[A_S_Time]',`Alloc_E_Time`='$_POST[A_E_Time]',`State`='$_POST[Sta]'
 WHERE `Berth_Alloc_Id`='$_POST[B_A_Id]'";
